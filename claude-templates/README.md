...
Copy **one** template into the root of your project as `CLAUDE.md`. Claude Code reads this file for project context, commands, and guardrails.

| Template | Use when |
| --- | --- |
| [`typescript/CLAUDE.md`](typescript/CLAUDE.md) | Node / TypeScript apps |
| [`nextjs/CLAUDE.md`](nextjs/CLAUDE.md) | Next.js (App Router) |
